...
Add a background Image or a new logo to the WP login pages.

All images sized accordingly.
...
1. Upload `kevinjohn_gallagher__login_control.php` to the `/wp-content/plugins/` directory
